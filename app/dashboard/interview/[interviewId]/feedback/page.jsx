...
const Feedback = ({ params }) => {
  ...
  return (
    <div className="p-10">
        ...
        <>
         ...
         <h2 className="font-bold text-2xl">Here is your interview feedback</h2>
          ...
          <h2 className="text-sm text-gray-500">
            Check out the interview question with correct answer below, Your answer and
      ...
      <Button className="cursor-pointer" onClick={() => router.replace("/dashboard")}>Go Home</Button>
    </div>
  );
};
